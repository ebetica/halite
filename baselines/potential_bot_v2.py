...
class Args:
    debug = 0
    pa = -0.48894660958979425
    pw_mp = np.exp(0.26670891324299223)
    pe = 0.17991685639098198
    pi_mp = np.exp(0.08240264409076659)
    pt_me = 0.6466466147608383
    pe_me = 0.4385638304641041
    pp = 0.7976887201820693
    pi_me = 0.4961495164562315
    pi_ms = 0.36596059926116253
    pp_mp = np.exp(-0.35749631396437315)
    pp_ms = 0.6085823416162076
    pa_me = 0.40566797395041887
    pi = 0.2928045064409931
    pp_me = 0.5905251380126546
    pa_mp = np.exp(-1.2829690411316044)
    pt_ms = 0.5800623660475179
    pw_ms = 0.5157028312212666
    pn_me = 0.8286254273262655
    pe_ms = 0.47426437627443385
    pt_mp = np.exp(-0.3814343204912056)
    pn_ms = 0.608996101360004
    pe_mp = np.exp(0.25994822319232114)
    pt = 0.35845840418873687
    pw = 0.27991460182510164
    pw_me = 0.020703589943182665
    pa_ms = 0.38349500625078004
    pn = 0.4804054925415939
    pn_mp = np.exp(0.8212395956479523)
